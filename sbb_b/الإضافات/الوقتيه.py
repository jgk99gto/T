...
ZelzalVP_cmd = (
    ...
    "⪼ `.وقتيه 16`\n\n"
    "⪼ `.وقتيه 17`\n\n\n"
    "**✾╎لـ رؤيـة زغـارف البروفايـل الوقتـي ↶**  [⦇  اضـغـط هنــا  ⦈](t.me/ZZZ7iZ) \n\n"
    "**✾╎لـ رؤيـة زغـارف الاســم الوقتـي ↶**  [⦇  اضـغـط هنــا  ⦈](t.me/ZZZ7iZ) \n\n\n"
...
# Copyright (C) 2022 @Zed-Thon . All Rights Reserved
@sbb_b.zed_cmd(pattern="وقتيه(?:\s|$)([\s\S]*)")
...
# Copyright (C) 2022 @Zed-Thon . All Rights Reserved
@sbb_b.zed_cmd(pattern="الوقتي(?:\s|$)([\s\S]*)")
...
# Copyright (C) 2022 @Zed-Thon . All Rights Reserved
@sbb_b.zed_cmd(pattern="اوامر الوقتي")
...
# Copyright (C) 2022 @Zed-Thon . All Rights Reserved
@sbb_b.zed_cmd(pattern="الخط(?:\s|$)([\s\S]*)")
async def variable(event):
    input_str = event.pattern_match.group(1)
