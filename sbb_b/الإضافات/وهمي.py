...
@sbb_b.zed_cmd(pattern="الطقس(?: |$)(.*)")
async def _(event):
    await edit_or_reply(event, "**- ارسـل .طقس + اسـم المدينـة**\n\n**- مثــال :**\n.طقس بغداد")


@sbb_b.zed_cmd(pattern="طقس (.*)")
async def _(event):
    if event.fwd_from:
        return
...
@sbb_b.zed_cmd(pattern="وهمي كتابه(?: |$)(.*)")
async def _(event):
...
@sbb_b.zed_cmd(pattern="وهمي صوت(?: |$)(.*)")
async def _(event):
    t = event.pattern_match.group(1)
    if not (t or t.isdigit()):
        t = 100
...
@sbb_b.zed_cmd(pattern="وهمي فيديو(?: |$)(.*)")
async def _(event):
    t = event.pattern_match.group(1)
    if not (t or t.isdigit()):
        t = 100
...
@sbb_b.zed_cmd(pattern="وهمي لعبه(?: |$)(.*)")
async def _(event):
    t = event.pattern_match.group(1)
    if not (t or t.isdigit()):
        t = 100
