...
زلــزال الـهيبــه - @ZZZ7iZ
- حقـوق زدثـــون @H_M_Dr
...
ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت الخليفه "
ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "⎉ "
ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆⎈•━━⊶𐂡•𝑠𝑜𝑢𝑟𝑐𝑒 𝑐𝑎𝑙𝑖𝑝ℎ•𐂡⊷━━•⎈⋆"
...
# الـرتب الوهميـه كتـابـة الكـود - زلــزال الـهيبــه @zzzzl1l
    ...
    zel_dev = (5012406813, 5012406813, 5012406813)
    if user_id == 5012406813 or user_id == 5012406813 or user_id == 5012406813:
