...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> • 🌚 | نــوعه   ⇦  حمار وحشي 🦓 </b>\n"
       caption += f"<b> • 🌚 | نسبتـه  ⇦  {yoy} </b>\n\n\n"
       caption += f"<b> 𝑠𝑜𝑢𝑟𝑐𝑒 𝑐𝑎𝑙𝑖𝑝ℎ </b> - @ZZZ7iZ "
    ...
    if x == 2:
       ...
       caption += f"<b> • 🌚 | ايـديه   ⇦ </b> <code>{user_id}</code>\n"
       caption += f"<b> • 🌚 | صـوره  ⇦ </b> {replied_user_profile_photos_count} </b>\n"
       caption += f"<b> • 🌚 | نــوعه   ⇦  كلب شوارع 🐕‍🦺 </b>\n"
       caption += f"<b> • 🌚 | نسبتـه  ⇦  {yoy} </b>\n\n\n"
       caption += f"<b> 𝑠𝑜𝑢𝑟𝑐𝑒 𝑐𝑎𝑙𝑖𝑝ℎ </b> - @ZZZ7iZ "
    ...
    if x == 4:
       ...
       caption += f"<b> • 🌚 | ايـديه   ⇦ </b> <code>{user_id}</code>\n"
       caption += f"<b> • 🌚 | صـوره  ⇦ </b> {replied_user_profile_photos_count} </b>\n"
       caption += f"<b> • 🌚 | نــوعه   ⇦  معزه محترمه 🐐 </b>\n"
       caption += f"<b> • 🌚 | نسبتـه  ⇦  {yoy} </b>\n\n\n"
       caption += f"<b> 𝑠𝑜𝑢𝑟𝑐𝑒 𝑐𝑎𝑙𝑖𝑝ℎ </b> - @ZZZ7iZ "
    ...
    if x == 5:
       ...
       caption += f"<b> • 🌚 | ايـديه   ⇦ </b> <code>{user_id}</code>\n"
       caption += f"<b> • 🌚 | صـوره  ⇦ </b> {replied_user_profile_photos_count} </b>\n"
       caption += f"<b> • 🌚 | نــوعه   ⇦  خروف العيد 🐑 </b>\n"
       caption += f"<b> • 🌚 | نسبتـه  ⇦  {yoy} </b>\n\n\n"
       caption += f"<b> 𝑠𝑜𝑢𝑟𝑐𝑒 𝑐𝑎𝑙𝑖𝑝ℎ </b> - @ZZZ7iZ "
    ...
    if x == 6:
       ...
       caption += f"<b> • 🌚 | ايـديه   ⇦ </b> <code>{user_id}</code>\n"
       caption += f"<b> • 🌚 | صـوره  ⇦ </b> {replied_user_profile_photos_count} </b>\n"
       caption += f"<b> • 🌚 | نــوعه   ⇦  قطه ابوخالد 🐈 </b>\n"
       caption += f"<b> • 🌚 | نسبتـه  ⇦  {yoy} </b>\n\n\n"
       caption += f"<b> 𝑠𝑜𝑢𝑟𝑐𝑒 𝑐𝑎𝑙𝑖𝑝ℎ </b> - @ZZZ7iZ "
    ...
    if x == 7:
       ...
       caption += f"<b> • 🌚 | ايـديه   ⇦ </b> <code>{user_id}</code>\n"
       caption += f"<b> • 🌚 | صـوره  ⇦ </b> {replied_user_profile_photos_count} </b>\n"
       caption += f"<b> • 🌚 | نــوعه   ⇦  برايص ابو بريصه 🦎 </b>\n"
       caption += f"<b> • 🌚 | نسبتـه  ⇦  {yoy} </b>\n\n\n"
       caption += f"<b> 𝑠𝑜𝑢𝑟𝑐𝑒 𝑐𝑎𝑙𝑖𝑝ℎ </b> - @ZZZ7iZ "
    ...
    if x == 8:
       ...
       caption += f"<b> • 🌚 | ايـديه   ⇦ </b> <code>{user_id}</code>\n"
       caption += f"<b> • 🌚 | صـوره  ⇦ </b> {replied_user_profile_photos_count} </b>\n"
       caption += f"<b> • 🌚 | نــوعه   ⇦  الفرافير ابو فار 🐀 </b>\n"
       caption += f"<b> • 🌚 | نسبتـه  ⇦  {yoy} </b>\n\n\n"
       caption += f"<b> 𝑠𝑜𝑢𝑟𝑐𝑒 𝑐𝑎𝑙𝑖𝑝ℎ </b> - @ZZZ7iZ "
    ...
    if x == 9:
       ...
       caption += f"<b> • 🌚 | ايـديه   ⇦ </b> <code>{user_id}</code>\n"
       caption += f"<b> • 🌚 | صـوره  ⇦ </b> {replied_user_profile_photos_count} </b>\n"
       caption += f"<b> • 🌚 | نــوعه   ⇦  بقره 🐄 </b>\n"
       caption += f"<b> • 🌚 | نسبتـه  ⇦  {yoy} </b>\n\n\n"
       caption += f"<b> 𝑠𝑜𝑢𝑟𝑐𝑒 𝑐𝑎𝑙𝑖𝑝ℎ </b> - @ZZZ7iZ "
       return sts_animal9, caption


@sbb_b.zed_cmd(pattern="حيوان(?: |$)(.*)")
async def who(event):
    zed = await edit_or_reply(event, "⇆")
    zel_dev = (5289124437, 627658332, 5190136458, 1050898456, 1121532100)
    ...
    if replied_user.id in zel_dev:
       return await edit_or_reply(zed, "**- حياتي🥸 . . هذا مطور السورس . . انتـه الحيـوان **")
    if replied_user.id == 5012406813 or replied_user.id == 5012406813 or replied_user.id == 5012406813:
       return await edit_or_reply(zed, "**- حياتي🥸 . . انـهُ المطـور . . انتـه الحيـوان **")
