...
@sbb_b.zed_cmd(pattern="ملصق متحرك(?: |$)(.*)")
...
@sbb_b.zed_cmd(pattern="لمتحركه(?: |$)((-)?(r|l|u|d|s|i)?)$")
...
@sbb_b.zed_cmd(pattern="متحرك ?([0-9.]+)?$")
async def _(event):
    reply = await event.get_reply_message()
