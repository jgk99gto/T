...
async def _(event):
    ...
    try:
        ...
        await event.client.send_file(
            ...
            caption=f"**🎆┊حـالات واتـس قصيـرة 🧸♥️**\n\n[𝑠𝑜𝑢𝑟𝑐𝑒 𝑐𝑎𝑙𝑖𝑝ℎ](https://t.me/ZZZ7iZ)",
        )
...
@sbb_b.zed_cmd(pattern="ستوري انمي$")
async def _(event):
...
@sbb_b.zed_cmd(pattern="ولد انمي$")
async def _(event):
...
@sbb_b.zed_cmd(pattern="بنت انمي$")
async def _(event):
    zzevent = await edit_or_reply(event, "**╮ - جـارِ تحميـل الآفتـار ...𓅫╰**")
    try:
        zedph = [
