...
async def _(event):
    ...
    sandy = await edit_or_reply(
        ...
        f"**•⎆┊يتـم الان اعـادة تشغيـل بـوت ارتكس قـد يستغـرق الامـر 1-2 دقيقـه ▬▭ ...**",
    )
    try:
...
@sbb_b.zed_cmd(
    ...
    info={
        ...
        "الوصـف": "لـ إطفـاء الداينـو الخاص بتنصيبك بهيروكـو .. لا تستطيع اعاده التشغيل مرة اخرى عبر حسابك عليك الذهاب لحساب هيروكو واتباع الشرح التالي https://t.me/pp_g3",
...
async def _(event):
    ...
    await edit_or_reply(event, "**✾╎جــارِ إيقـاف تشغيـل بـوت ارتكس الآن 📟 ...**\n\n**✾╎شغِّـلنـي يـدويًـا لاحقًــا**\n**✾╎باتبـاع الشـرح** https://t.me/pp_g3")
