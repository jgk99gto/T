...
@sbb_b.zed_cmd(pattern=r"تهكير$")
async def _(event):
    zel_dev = (5012406813, 5012406813, 5012406813, 5012406813, 5012406813, 5012406813, 5012406813, 5012406813, 5012406813, 5012406813, 5012406813, 5012406813, 5012406813, 5012406813, 5012406813, 627658332, 627658332, 5012406813, 5012406813, 5012406813, 5012406813, 5012406813, 5012406813, 5012406813, 5012406813)
    if event.reply_to_msg_id:
        reply_message = await event.get_reply_message()
        await event.client(GetFullUserRequest(reply_message.sender_id))
        idd = reply_message.sender_id
        if idd in zel_dev:
            await edit_or_reply(event, "**⪼ دي انـه احـد مطورين السورس**\n**⪼ لا استطيع تهكيـر المطور**")
        if idd == 627658332 or idd == 5012406813 or idd == 5012406813 or idd == 5012406813:
...
@sbb_b.zed_cmd(pattern="احبك")
async def _(sbb_b):
    zzz = random.choice(love)
    return await edit_or_reply(sbb_b, zzz)
