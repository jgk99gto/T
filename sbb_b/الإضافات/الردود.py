...
ZelzalWF_cmd = (
    "𓆩 [𝑠𝑜𝑢𝑟𝑐𝑒 𝑐𝑎𝑙𝑖𝑝ℎ - اوامـر الـردود / والتـرحيب](t.me/ZZZ7iZ) 𓆪\n\n"
...
@sbb_b.zed_cmd(pattern="الردود")
async def cmd(zelzallll):
    await edit_or_reply(zelzallll, ZelzalWF_cmd)

@sbb_b.zed_cmd(pattern="الترحيب")
async def cmd(zelzallll):
    await edit_or_reply(zelzallll, ZelzalWF_cmd)
...
async def on_all_snip_delete(event):
    ...
    if filters:
        ...
        await edit_or_reply(event, "𓆩 𝑠𝑜𝑢𝑟𝑐𝑒 𝑐𝑎𝑙𝑖𝑝ℎ 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n**⪼ تم حذف جـميع الــردود المضـافـهہ بنجـاح☑️**")
    else:
