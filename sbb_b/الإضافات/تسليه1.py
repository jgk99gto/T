...
@sbb_b.zed_cmd(pattern="سبونج بوب")
async def kek(kek):
    await kek.edit(M)
    D = (
        "╭━┳━╭━╭━╮╮\n"
...
@sbb_b.zed_cmd(pattern="ثعلب")
async def fox(fox):
    await fox.edit(F)


@sbb_b.zed_cmd(pattern="فيل")
async def elephant(elephant):
    await elephant.edit(E)


@sbb_b.zed_cmd(pattern="معصب")
async def homer(homer):
    await homer.edit(H)


@sbb_b.zed_cmd(pattern="خنزير")
async def pig(pig):
    await pig.edit(P)
...
@sbb_b.zed_cmd(pattern="معارض")
async def marth(marth):
    await marth.edit(L)



@sbb_b.zed_cmd(pattern="مروحيه(?: |$)(.*)")
async def _(event):
...
@sbb_b.zed_cmd(pattern="ابره(?:\s|$)([\s\S]*)")
